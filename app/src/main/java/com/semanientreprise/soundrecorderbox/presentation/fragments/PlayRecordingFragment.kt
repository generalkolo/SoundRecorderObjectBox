...
class PlayRecordingFragment : DialogFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        minutes = TimeUnit.MILLISECONDS.toMinutes(itemDuration.toLong())
        seconds = TimeUnit.MILLISECONDS.toSeconds(itemDuration.toLong()) - TimeUnit.MINUTES.toSeconds(minutes)
    }
    ...
    override fun onStart() {
        ...
        val alertDialog = (dialog as AlertDialog).apply {
